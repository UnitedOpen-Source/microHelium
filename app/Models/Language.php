...
class Language extends Model
{
    ...
    public static function getDefaultLanguages(): array
    {
        return [
            ...
            ['name' => 'Java (OpenJDK 17 LTS)', 'extension' => 'java17', 'file_ext' => 'java', 'compile_command' => '/usr/lib/jvm/java-17-openjdk/bin/javac {source}', 'run_command' => '/usr/lib/jvm/java-17-openjdk/bin/java -Xss8m -Xmx{memory}m {classname}', 'is_active' => false, 'category' => 'compiled'],
