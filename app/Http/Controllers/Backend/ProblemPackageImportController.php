...
class ProblemPackageImportController extends Controller
{
    ...
    public function store(Request $request, IcpcPackageReader $reader, IcpcPackageImporter $importer, SafeZipExtractor $extractor): RedirectResponse
    {
        ...
        try {
            ...
            try {
                // Issue #242 -- a guarda roda ANTES de qualquer escrita: um
                // pacote recusado nao pode deixar meia extracao no disco.
                $extractor->extractTo($zip, $extractDir);
