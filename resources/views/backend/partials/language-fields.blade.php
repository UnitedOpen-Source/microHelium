...
<div class="p-6 space-y-4">
    <div>
        ...
        <input id="{{ $idPrefix }}_name" type="text" name="name" value="{{ old('name', $language->name ?? '') }}" maxlength="50" class="w-full px-3 py-2 bg-background border border-border rounded-lg text-foreground focus:ring-2 focus:ring-primary focus:border-transparent" placeholder="Ex: C++ (G++ 13)" required>
    ...
    <div>
        <label class="flex items-center gap-2">
            <input type="checkbox" name="is_active" value="1" @checked(old('is_active', $isEdit ? $language->is_active : true)) class="rounded border-border">
