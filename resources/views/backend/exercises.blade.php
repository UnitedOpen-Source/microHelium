    ...
    <div class="bg-card rounded-lg border border-border shadow-sm">
        <div class="p-6 border-b border-border">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h2 class="text-xl font-semibold text-foreground">Problemas cadastrados</h2>
                    <p class="text-sm text-muted-foreground mt-1">Lista de todos os exercicios/problemas da competicao</p>
                </div>
                <button onclick="openModal('addExerciseModal')" class="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary-hover transition-colors">
                    ...
                    <tr class="hover:bg-muted/50 transition-colors">
                        ...
                        <td class="px-4 py-3">
                            @if(($exercise->difficulty ?? 'medium') == 'easy')
                                <span class="px-2 py-1 text-xs font-medium bg-success-soft text-success rounded">Fácil</span>
                            @elseif(($exercise->difficulty ?? 'medium') == 'medium')
                                <span class="px-2 py-1 text-xs font-medium bg-warning-soft text-warning rounded">Médio</span>
                            @else
                                <span class="px-2 py-1 text-xs font-medium bg-destructive-soft text-destructive rounded">Difícil</span>
                            @endif
                        </td>
