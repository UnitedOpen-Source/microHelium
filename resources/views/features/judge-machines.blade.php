@extends('layouts.app')
@section('title', 'Máquinas de julgamento')
@section('description', 'Veja quais máquinas estão julgando, quais pararam de responder e emita credenciais.')
@section('content')

<div data-feature-page="judge-machines" data-mode="library" data-problem-id="{{ request()->route('problemId') }}">
