@extends('layouts.app')
@section('title', 'Meu histórico de treino')
@section('description', 'Acompanhe as soluções enviadas fora das competições.')
@section('content')

<div data-feature-page="practice" data-mode="history" data-problem-id="{{ request()->route('problemId') }}">
