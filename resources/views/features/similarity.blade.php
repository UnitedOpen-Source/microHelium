@extends('layouts.app')
@section('title', 'Similaridade de código')
@section('description', 'Compare soluções aceitas e reúna evidências para uma revisão humana.')
@section('content')
<a href="/backend/tools" class="button-secondary mb-5">Voltar às ferramentas</a>
<div data-feature-page="similarity" data-mode="library" data-problem-id="{{ request()->route('problemId') }}">
