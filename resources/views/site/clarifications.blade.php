...
@section('title', 'Clarificações do Site')

@section('description', 'Responda às dúvidas dos times do seu site.')
...
<div class="space-y-6">
    ...
    <div class="bg-card rounded-lg border border-border shadow-sm">
        ...
        <div class="filter-toolbar" data-status-filter="site-clarifications">
        ...
        <div id="site-clarifications" class="p-6 space-y-4">
                ...
                <div class="flex flex-col lg:flex-row gap-4">
                    <div class="flex-1">
                        <div class="flex flex-wrap items-center gap-2 mb-3">
                            <span class="font-semibold text-foreground">{{ $clarification->team_name ?? 'Time #' . $clarification->user_id }}</span>
                        ...
                        @else
                            <form action="{{ route('site.clarifications.answer', $clarification->id) }}" method="POST">
                                @csrf
                                <div class="mb-3">
                    ...
                    <div class="flex lg:flex-col items-center justify-center lg:w-32">
                        @if($clarification->answered)
                            <span class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium bg-success-soft text-success rounded-lg">Respondida</span>
                        @else
                            <span class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium bg-warning-soft text-warning rounded-lg">Pendente</span>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="text-center py-12">
                ...
                <p class="text-muted-foreground">Nenhuma clarificacao recebida neste site</p>
            </div>
            @endforelse
